...
# Dicionários globais para manter o estado das posições e dos modelos preditivos
positions = (
    {}
)  # Ex: positions["DOGEUSDT"] = {"positionOpen": False, "lastBuyPrice": None}
predictiveModels = {}  # Armazena o modelo preditivo para cada símbolo
